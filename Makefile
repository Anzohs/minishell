...
SRC_MS = create_pwd.c m_copy_env.c mini.c ft_cmdlst_new.c ft_cmdlstadd_back.c create_oldpwd.c \
		ft_cmdlstclear.c ft_cmdlstdelone.c ft_cmdlst_len.c get_var.c matrix_len.c
SRC_LIBFT = ft_atoi.c ft_bzero.c ft_calloc.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c \
			...
			ft_strrchr.c ft_strtrim.c ft_substr.c ft_tolower.c ft_toupper.c ft_lsthas.c ft_lstgetlst.c ft_lstsort.c
...
SRC_EXE = execute.c cd_execute.c pwd_execute.c export_built.c
